 ...
 *----------------------------------------------------------------------**/
public class ShowAllReviews extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (userInfoOnSession != null) {
			...
			ShowAllReviewsBL logic = new ShowAllReviewsBL();
						
			list = logic.executeSelectReviews();

			request.setAttribute( "ALL_REVIEWS_LIST" , list );

			RequestDispatcher dispatch = request.getRequestDispatcher("/view/allreviews.jsp");
