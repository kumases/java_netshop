...
<body class="wrapper">
	...
	<table style="width: 100%">
		...
		<tr>
			...
			<td><p style="width: 100%; text-align: center"><%=dto.getCart_number()%>個
				</p></td>
	...
	<div style="width:80%;">
	<form action="BuyFinish" method="post" style="display: flex">
		<input type="submit" value="確定する" class="btn btn-success" style="width:100%">
	</form>
	</div>
