...
<div class="msg" style="width:100%; word-wrap: break-word;">
            <p style="border-top:solid 2px lightgray;">ユーザー名：<%=replaceEscapeChar(dto.getUsers_name())%><br></p>
            <p>商品名：<%=replaceEscapeChar(dto.getItems_name()) %><p>
